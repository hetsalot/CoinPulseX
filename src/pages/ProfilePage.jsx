...
const ProfilePage = () => {
  ...
  return (
    <div className="page-container page-container--narrow">
      {/* Auth Notice Banner */}
      {authError && (
        <div className="mb-8 p-5 rounded-2xl bg-rose-950/40 border border-rose-500/35 text-rose-200 text-xs flex items-start justify-between gap-3 animate-fade-in">
          <div>
      ...
      {!user ? (
        ...
        <div className="space-y-10">
          <div className="text-center space-y-4 animate-fade-in-up">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight text-white leading-[1.1]">
              Real-Time Crypto Simulation & <br />
              <span className="text-gradient-brand">
                Portfolio Management
              </span>
            </h1>
            <p className="text-sm sm:text-base text-slate-400 max-w-xl mx-auto leading-relaxed">
              Trade cryptocurrencies with live Binance order flows, track your portfolio in real time, and practice trading with zero financial downside.
            </p>
          </div>

          {/* 3 Feature Pills */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 animate-fade-in-up delay-1">
            <div className="glass-card p-6 rounded-2xl text-center space-y-2.5">
              ...
              <h3 className="font-bold text-white text-sm">Live Binance Feed</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Sub-second spot price ticks across 20 top crypto assets.</p>
            </div>
            <div className="glass-card p-6 rounded-2xl text-center space-y-2.5">
              ...
              <h3 className="font-bold text-white text-sm">Portfolio Tracking</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Live asset valuation and CCoins balance sync with database.</p>
            </div>
            <div className="glass-card p-6 rounded-2xl text-center space-y-2.5">
              ...
              <h3 className="font-bold text-white text-sm">Zero Capital Risk</h3>
              <p className="text-xs text-slate-400 leading-relaxed">Trade freely with simulated CCoins credits without real risk.</p>
            </div>
          </div>

          {/* Sign In Card */}
          <div className="glass-card-elevated rounded-2xl p-8 sm:p-10 max-w-md mx-auto shadow-2xl space-y-7 animate-fade-in-up delay-2">
            ...
            <button
              ...
              className="w-full flex items-center justify-center space-x-3 bg-white hover:bg-slate-100 text-slate-900 font-bold py-3.5 px-4 rounded-xl transition duration-200 shadow-md hover:shadow-cyan-500/20 cursor-pointer text-sm"
            >
            ...
            <div className="pt-6 border-t border-white/[0.06] space-y-4">
              <div className="flex items-center justify-between text-xs">
                ...
                <span className="text-[10px] font-mono text-slate-400 bg-slate-950/80 px-2.5 py-1 rounded-lg border border-white/[0.08]">
                  1-Click Dev Mode
                </span>
              </div>
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-500 hover:to-cyan-400 text-slate-950 font-bold py-3 px-4 rounded-xl transition duration-200 cursor-pointer text-sm shadow-lg shadow-cyan-500/20"
              >
        ...
        <div className="space-y-8">
          ...
          <div className="glass-card-elevated rounded-2xl p-7 sm:p-9 shadow-2xl relative overflow-hidden animate-fade-in-up">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="flex items-center space-x-5">
                {user.photoURL ? (
                  <img
                    src={user.photoURL}
                    alt="Trader Avatar"
                    className="w-18 h-18 rounded-2xl border-2 border-cyan-400/50 shadow-xl object-cover"
                    style={{ width: "72px", height: "72px" }}
                  />
                ) : (
                  <div
                    className="rounded-2xl bg-cyan-950 border-2 border-cyan-500/40 flex items-center justify-center text-cyan-300 font-bold text-2xl"
                    style={{ width: "72px", height: "72px" }}
                  >
              ...
              <button
                onClick={logout}
                className="flex items-center space-x-2 px-4 py-2.5 rounded-xl bg-rose-500/10 hover:bg-rose-500/20 text-rose-400 border border-rose-500/25 text-xs font-semibold transition cursor-pointer self-start sm:self-auto"
              >
            ...
            <div className="mt-8 pt-7 border-t border-white/[0.06] grid grid-cols-1 md:grid-cols-2 gap-5">
              <div className="p-5 rounded-xl bg-slate-950/60 border border-white/[0.05] flex items-center justify-between">
                <div>
                  <span className="text-[11px] uppercase font-mono tracking-wider text-slate-400 block">
                    Simulated Liquid Balance
                  </span>
                  <span className="text-2xl font-black text-cyan-300 num-font mt-1 block">
                    <UserBalance />{" "}
              ...
              <div className="p-5 rounded-xl bg-slate-950/60 border border-white/[0.05] flex items-center justify-between">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl bg-cyan-500/10 hover:bg-cyan-500/20 border border-cyan-500/25 text-cyan-300 text-xs font-mono font-semibold flex items-center space-x-1.5 transition cursor-pointer"
                >
            ...
            {refillNotice && (
              <div className="mt-4 p-4 rounded-xl bg-cyan-950/50 border border-cyan-500/25 text-cyan-300 text-xs flex items-center space-x-2.5 animate-fade-in">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 animate-fade-in-up delay-1">
            <Link
              to="/dashboard"
              className="glass-card glass-card-hover p-6 rounded-2xl flex items-center justify-between group"
            >
